...
## Inviting Mimitsu to your server

Click [here](https://discordapp.com/api/oauth2/authorize?client_id=672591094953017374&permissions=2048&scope=bot) if you want to invite Mimitsu to your server.
...
But, if you prefer, you can install and configure manuall
...
# Using NPM:
npm i @rocketseat/gatsby-theme-doc
```
